...
import 'medication_view.dart'; // Ensure this file contains the MedicationView class definition
...
void initState() {
  super.initState();
  _pages = [
    HomeContent(onGoToAppointments: () {
      setState(() {
        _currentIndex = 2;
      });
    }),
    MedicationView(), // Ensure MedicationView is defined in the imported file
    AppointmentsView(),
    RecordsView(),
    MessagesView(),
  ];
  ...
  Widget _navIcon(IconData icon, int index) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(
          icon,
          color: isSelected ? const Color.fromARGB(255, 16, 57, 71): const Color(0xFFB9E7F0),
          size: 26,
        ),
      ),
    );
...
Column(
  children: const [
    Icon(Icons.calendar_month, size: 30, color: Color(0xFF23414E)),
    SizedBox(height:34),
    Icon(Icons.access_time, size: 24, color: Color(0xFF23414E)),
  ],
),
...
Text(
  ...
  child: const Icon(Icons.error_outline, size: 30, color: Color.fromARGB(255, 15, 60, 66)),
)
      ...
      child: Row(
        children: [
          Expanded(
            child: Text(
              name,
              style: TextStyle(fontSize: 13, fontFamily: "Poppins", color: Tcolor.primary.withOpacity(0.8), fontWeight: FontWeight.w500),
            ),
          ),
          Icon(Icons.access_time, size: 18, color: Tcolor.primary.withOpacity( 0.8)),
          const SizedBox(width: 6),
          Text(time, style: TextStyle(fontSize: 10, color: Tcolor.primary.withOpacity(0.8), fontFamily: "Poppins")),
        ],
      ),
    );
  }
