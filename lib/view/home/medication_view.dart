  ...
  children: [
    Row(
      children: [
        ...
        Text(
          med['from'],
          style: const TextStyle(color: Color(0xFF23414E), fontFamily: 'Poppins', fontSize: 12),
        ),
      ],
    ),
          ...
          style: const TextStyle(color: Color(0xFF23414E), fontFamily: 'Poppins', fontSize: 12),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  const Text("Status: ", style: TextStyle(color: Colors.grey, fontFamily: 'Poppins', fontSize: 12)),
